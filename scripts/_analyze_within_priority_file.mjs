...
const detectBank = () => {
  ...
  if (questions[0]?.id?.startsWith('hist') || questions[0]?.id?.startsWith('t')) return { bank: 'history', base: '' }
...
const FILES_BY_BANK = {
  party: [
    { file: '党史题库_按优先级整理.md', label: '按优先级整理', groups: ['party-p1', 'party-p2', 'party-p3', 'party-p4'] },
    { file: '党史题库_完整版.md', label: '完整版', groups: ['party-single', 'party-multi', 'party-judge'] },
  ],
  military: [
    { file: '军理题库_按优先级整理.md', label: '按优先级整理', groups: ['military-p1', 'military-p2', 'military-p3', 'military-p4'] },
    { file: '军理题库_整理版.md', label: '按章节整理', groups: ['military-ch1', 'military-ch2', 'military-ch3', 'military-ch4', 'military-ch5', 'military-ch6', 'military-ch7', 'military-ch8', 'military-ch9', 'military-ch10', 'military-ch11', 'military-ch12', 'military-ch13', 'military-ch14', 'military-ch15', 'military-ch16', 'military-ch17', 'military-ch18'] },
  ],
  history: [
...
const filesToCheck = fileKey === 'priority'
